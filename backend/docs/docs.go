...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Mentai Mental Dev",
            "email": "dev@mentaimental.com"
        },
        "license": {
            "name": "MIT"
        },
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.BusyHourItem"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.CategorySalesItem"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.CustomerRankingItem"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.PaymentMethodItem"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/handler.RunoutPrediction"
                                            }
                                        }
                                    }
                                }
        ...
        "/analytics/sales-trend": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Period grouping: daily or monthly (default daily)",
                        "name": "period",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateIngredientRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateIngredientRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter only active products (backward compatibility)",
                        "name": "only_active",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.RecipeItem"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handler.SaveRecipeItemRequest"
                            }
                        }
                    }
                ],
        ...
        "/settings": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Settings key-value updates",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.MidtransPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/transactions/{id}/send-whatsapp-receipt": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/handler.SendWhatsAppReceiptRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.CreateIngredientRequest": {
            "type": "object",
            "required": [
                "name",
                "unit"
        ...
        "handler.RunoutPrediction": {
            ...
            "properties": {
                ...
                "days_remaining": {
                    "description": "-1 means infinite/no usage",
                    "type": "number"
                },
        ...
        "handler.SendWhatsAppReceiptRequest": {
            "type": "object",
            "properties": {
                "phone": {
                    "type": "string"
        ...
        "handler.UpdateIngredientRequest": {
            "type": "object",
            "required": [
                "current_stock",
                "name",
